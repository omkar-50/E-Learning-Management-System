...
if(isset($_SESSION['is_admin_login'])){
    ...
    echo "<script>document.getElementsByTagName('title')[0].innerHTML='Edit Students';</script>";
}
else{
...
if(isset($_REQUEST['stuReqUpdate'])){
...
<div class="text-center">
    <button class="btn btn-danger" type="submit" id="stuReqUpdate" name="stuReqUpdate">Update</button>
