...
if(isset($_SESSION['is_admin_login'])){
    ...
    echo "<script>document.getElementsByTagName('title')[0].innerHTML='Sell Report';</script>";
}
else{
...
<div class="col-sm-9 mt-5">
    <form action="" method="POST" class="d-print-none">
        <div class="form-row">
            ...
            <span class="ml-3 mr-3 mt-2"> To </span>
            <div class="form-group col-md-2">
        ...
        if(isset($_REQUEST['searchsubmit'])){
            ...
            $result = $conn->query($sql);
                if($result->num_rows > 0){
                    ...
                    echo "
                        <div class='alert alert-warning col-sm-6 mt-4' role='alert'> No Records Found ! </div>
                    ";
                }
        }
    ?>
