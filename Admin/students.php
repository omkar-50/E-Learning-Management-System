...
if(isset($_SESSION['is_admin_login'])){
    ...
    echo "<script>document.getElementsByTagName('title')[0].innerHTML='Students';</script>";
}
else{
...
<div>
    <a href="./addNewStudent.php" class="btn btn-danger box"><img class="iconsize" src="../icons/plus.svg" style="margin-top: -4px;"></a>
</div>
