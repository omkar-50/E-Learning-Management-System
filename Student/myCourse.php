<?php
    ...
    if(isset($_SESSION['is_login'])){
        ...
        echo "<script>document.getElementsByTagName('title')[0].innerHTML='My Courses';</script>";
    }
    else{
        ...
        <div class="jumbotron">
            ...
            ?>
                            <div class="bg-light mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?php echo $row['course_img']; ?>" alt="pic" class="card-img-top">
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <div class="card-body">
                                            <p class="card-title"><?php echo $row['course_desc'] ?></p>
                                            <small class="card-text">Duration :<?php echo $row['course_duration'] ?></small><br/>
                                            <small class="card-text">Instuctor :<?php echo $row['course_author'] ?></small><br/>
