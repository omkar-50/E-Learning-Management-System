            ...
            <script>
                    ...
                    if(cn6 == ""){
                        ...
                        <?php                            
                            ...
                            if(isset($_POST['ORDER_ID']) && ($_POST['TXN_AMOUNT'])){
                                ...
                                $sql = "INSERT INTO courseorder(order_id, stu_email, course_id,status,amount,order_date) VALUES ('$order_id', '$stu_email', '$course_id', '$status', '$amount', '$date')";
                ...
                function fun(){
                    ...
                    if((cn1 == "") || (cn2 == "") ||  (cn3 == "") ||  (cn4 == "") ||  (cn5 == "")){
                        ...
                        document.getElementById('cont').innerHTML = '<form action="" method="POST"><div class="text-center mt-5"><label class="mt-5"><label class="mt-5"><h5 style="color:blue;">OTP is sent to registered mobile number</h5></label><h3>Enter OTP</h3></label><br><input type="text" id="otp" name="otp" class="mt-5" maxlength="6" required></div><div class="text-center mt-5"><input type="submit" name="btn2" class="btn btn-primary" value="Verify" onclick="fun2()"></div></form><div id="msg" style="color: red;"></div>';
                    }
                }
